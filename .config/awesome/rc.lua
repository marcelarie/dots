...
globalkeys = mytable.join(awful.key({altkey, "Control"}, "l",
...
end, {description = "show weather", group = "widgets"}), -- Screen brightness
...
awful.key({altkey}, "space", function()
    os.execute(string.format("i3-keyboard-layout cycle us es", 'run', 'dmenu'))
