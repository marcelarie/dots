...
theme.wallpaper = theme.dir .. "/dark.png"
...
local keyboardlayout = awful.widget.keyboardlayout(function(widget)
	widget:new()
end)
...
local bat = lain.widget.bat({
	settings = function()
		if bat_now.status and bat_now.status ~= "N/A" then
			...
			widget:set_markup(
				markup.font(theme.font, " " .. bat_now.perc .. "% ")
			)
		else
...
theme.volume = lain.widget.alsa({
	settings = function()
		...
		widget:set_markup(
			markup.font(theme.font, " " .. volume_now.level .. "% ")
		)
	end,
})
	...
	settings = function()
		widget:set_markup(
			markup.font(
				...
				markup(
					"#7AC82E",
					" " .. string.format("%06.1f", net_now.received)
				)
					.. " "
					.. markup(
						"#46A8C3",
